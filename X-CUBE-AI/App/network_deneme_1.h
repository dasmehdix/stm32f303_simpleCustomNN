...
#ifndef __AI_NETWORK_DENEME_1_H__
#define __AI_NETWORK_DENEME_1_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_NETWORK_DENEME_1_MODEL_NAME          "network_deneme_1"

#define AI_NETWORK_DENEME_1_IN_NUM       (1)
#define AI_NETWORK_DENEME_1_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 6, 1, NULL), \
}
#define AI_NETWORK_DENEME_1_IN_SIZE { \
  (1 * 1 * 6), \
}
#define AI_NETWORK_DENEME_1_IN_1_SIZE  (1 * 1 * 6)
#define AI_NETWORK_DENEME_1_IN_1_SIZE_BYTES  ((1 * 1 * 6) * 4)




#define AI_NETWORK_DENEME_1_OUT_NUM      (1)
#define AI_NETWORK_DENEME_1_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 2, 1, NULL), \
}
#define AI_NETWORK_DENEME_1_OUT_SIZE { \
  (1 * 1 * 2), \
}
#define AI_NETWORK_DENEME_1_OUT_1_SIZE  (1 * 1 * 2)
#define AI_NETWORK_DENEME_1_OUT_1_SIZE_BYTES  ((1 * 1 * 2) * 4)

#define AI_NETWORK_DENEME_1_N_NODES (6)

AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_deneme_1
 ...
 * @ref ai_network_deneme_1_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_deneme_1_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_NETWORK_DENEME_1_*
 * defines into file @ref network_deneme_1.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_deneme_1_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_NETWORK_DENEME_1_H__*/
